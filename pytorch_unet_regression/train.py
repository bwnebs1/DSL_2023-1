...
parser.add_argument("--task", default="denoising", choices=["denoising","inpainting","super resolution"], type=str, dest="task")
...
if network == "unet":
    ...
    net = AutoEncoder(nch=nch, nker=nker, norm="bnorm", learning_type=learning_type).to(device)
# elif network == "resnet":
